...
<?php
						$queryGallery = getConn()->prepare("SELECT * FROM table_gallery ORDER BY id ASC");
						$queryGallery->execute();
						$countGallery = $queryGallery->rowCount();
				
						if($countGallery > 0)
						{
                			foreach($queryGallery as $result)
                			{
?>								<tbody>
									<tr>
										<td> Foto <?php echo $result['id']; ?> </td>

										<td class="table-option">
											<a href="../gallery/photos/<?php echo $result['photo']; ?>" data-lightbox="mygallery" data-title="Foto <?php echo $result['id']; ?>"> 
												<img src="../_img/_options/show.png" alt="Visualizar Foto"> 
											</a>
										</td>
										
										<td class="table-option"> 
											<a href="update.php?id=<?php echo $result['id']; ?>"> 
												<img src="../_img/_options/update.png" alt="Atualizar Foto"> 
											</a> 
										</td>

										<td class="table-option"> 
											<a href="../_routines/gallery/deletion.php?id=<?php echo $result['id']; ?>&photo=<?php echo $result['photo']; ?>" onclick="return confirm('Excluir Foto <?php echo $result['id']; ?>?')"> 
												<img src="../_img/_options/delete.png" alt="Excluir Foto"> 
											</a> 
										</td>
									</tr>
								</tbody> 		
