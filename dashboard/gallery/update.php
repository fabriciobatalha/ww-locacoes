        ...
        <section class="my-5 text-center">
            ...
            <div class="container">
                ...
                <div class="text-center text-lg-left">
                    ...
                    <a class=" btn btn-outline-info" href="../gallery/history.php" role="button"> Voltar à Histórico </a>
                ...
                <div class="row">
                	...
                	<?php
                		...
                		$query = getConn()->prepare("SELECT * FROM table_gallery WHERE id='{$_GET['id']}'");
                	...
                	<form class="col-10 col-md-6 col-lg-4" action="../_routines/gallery/update.php" method="post" enctype="multipart/form-data">
						...
						<img class="mb-3 w-100 image-preview" src="photos/<?php echo $result->photo; ?>" alt="Foto WW Locações"> 
                               ...
                               $category = "Empurrador";
                                    ...
                                    $category = "Caminhão Munck";
                                        ...
                                        $category = "Escavadeira";
                                            ...
                                            $category = "Retro Escavadeira";
                                        }
                                            else if($result->category == 7) {
                                                $category = "Outros";
                                            }
...
?>         	
                 	    ...
                 	    <div class="form-group">
							...
							<select name="category" class="form-control" required>
								...
								<option value="<?php echo $result->category; ?>" selected disabled> <?php echo $category; ?> </option>
