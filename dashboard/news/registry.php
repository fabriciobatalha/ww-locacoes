        ...
        <section class="my-5 text-center">
            <div class="container">
                ...
                <div class="row">
                	...
                	<form class="col-10 col-md-6 col-lg-4" action="../_routines/news/registration.php" method="post" enctype="multipart/form-data">	
  						<div class="input-group mb-3">
  							...
  							<div class="custom-file">
    							<input type="file" name="cover" class="custom-file-input" accept="image/png, image/jpg, image/jpeg" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" required>
    							<label class="custom-file-label" for="inputGroupFile01"> Buscar </label>
  							</div>
						</div>

                    	<div class="form-group">
                    		<input type="text" name="title" class="form-control" maxlength="60" placeholder="Título" required>
                    	</div>

                    	<div class="form-group">
    						<textarea class="form-control noresize" name="description" maxlength="150" id="exampleFormControlTextarea1" rows="3" placeholder="Descrição" required></textarea>
  						</div>
                  	
                  		<div class="form-group">
    						<textarea class="form-control noresize" name="news" id="exampleFormControlTextarea1" rows="6" placeholder="Notícia" required></textarea>
  						</div>
