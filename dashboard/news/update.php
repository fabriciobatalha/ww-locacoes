        ...
        <section class="my-5 text-center">
            <div class="container">
                <div class="text-center text-lg-left">
                    <a class=" btn btn-outline-info" href="../news/history.php" role="button"> Voltar à Histórico </a>
                </div>
          
                <div class="my-5">
                    <h2 class="display-4 text-secondary"> Atualizar </h2>
                </div>
                ...
                <div class="row">
                	...
                	<?php
                		$query = getConn()->prepare("SELECT * FROM table_news WHERE id='{$_GET['id']}'");
						$query->execute();
						$result = $query->fetchObject();
					?>
                	
                	<form class="col-10 col-md-6 col-lg-4" action="../_routines/news/update.php" method="post" enctype="multipart/form-data">
						<div class="form-group d-none">
                    		<input type="number" name="id" value="<?php echo $result->id; ?>" class="form-control" placeholder="ID" required>
                    	</div>
                 	    
                	    <div class="form-group d-none">
                    		<input type="text" name="oldCover" class="form-control" value="<?php echo $result->cover; ?>" placeholder="Capa Antiga" required>
                    	</div>
                 	    ...
                 	    <div class="input-group mb-3">
  							...
  							<div class="custom-file">
    							<input type="file" name="cover" class="custom-file-input" accept="image/png, image/jpg, image/jpeg" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
    							<label class="custom-file-label" for="inputGroupFile01"> Buscar </label>
  							</div>
						</div>

                    	<div class="form-group">
                    		<input type="text" name="title" class="form-control" value="<?php echo $result->title; ?>" maxlength="60" placeholder="Título" required>
                    	</div>

                    	<div class="form-group">
    						<textarea class="form-control noresize" name="description" maxlength="150" id="exampleFormControlTextarea1" rows="3" placeholder="Descrição" required><?php echo $result->description; ?></textarea>
  						</div>
                  	
                  		<div class="form-group">
    						<textarea class="form-control noresize" name="news" id="exampleFormControlTextarea1" rows="6" placeholder="Notícia" required><?php echo $result->news; ?></textarea>
  						</div>
