        ...
        <section class="my-5 text-center">
            <div class="container">
                <div class="text-center text-lg-left">
                    <a class=" btn btn-outline-info" href="../index.php" role="button"> Voltar ao Site </a>
                </div>
          
                <div class="my-5">
                    <h2 class="display-4 text-secondary"> Painel de Controle </h2>
                </div>

                <div class="row text-center menu">
                	<div class="p-3 col-sm-6 col-lg-3">
                        <a href="gallery.php" class="block btn btn-info py-5 col-12">
                            <img src="_img/home/gallery.png" alt="Galeria">
                            <p class="mt-2"> Galeria </p>
                        </a>
                    </div>
                    
                    <div class="p-3 col-sm-6 col-lg-3">
                        <a href="news.php" class="block btn btn-info py-5 col-12">
                            <img src="_img/home/news.png" alt="Notícias">
                            <p class="mt-2"> Notícias </p>
                        </a>
                    </div>
                    
                    <div class="p-3 col-sm-6 col-lg-3">
                        <a href="users.php" class="block btn btn-info py-5 col-12">
                            <img src="_img/home/users.png" alt="Usuários">
                            <p class="mt-2"> Usuários </p>
                        </a>
                    </div>
                    
                    <div class="p-3 col-sm-6 col-lg-3">
                        <a href="#" class="block btn btn-info py-5 col-12">
                            <img src="_img/home/access-denied.png" alt="Acesso Negado">
                            <p class="mt-2"> Acesso Negado </p>
                        </a>
                    </div>
                </div>
            </div>
