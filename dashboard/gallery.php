    ...
    <body class="exo-2 bg-light">
        ...
        <section class="my-5 text-center">
            <div class="container">
                ...
                <div class="my-5">
                    <h2 class="display-4 text-secondary"> Galeria </h2>
                </div>

                <div class="row text-center menu">
                    <div class="p-3 col-sm-6 col-lg-3">
                        <a href="gallery/registry.php" class="block btn btn-info py-5 col-12">
                            <img src="_img/gallery/registry.png" alt="Cadastrar">
                            <p class="mt-2"> Cadastrar </p>
                        </a>
                    </div>
                    
                    <div class="p-3 col-sm-6 col-lg-3">
                        <a href="gallery/history.php" class="block btn btn-info py-5 col-12">
                            <img src="_img/gallery/history.png" alt="Histórico">
                            <p class="mt-2"> Histórico </p>
                        </a>
                    </div>
                </div>
            </div>
