    ...
    <body class="exo-2 bg-light">
        ...
        <section class="my-5 text-center">
            <div class="container">
                ...
                <div class="my-5">
                    <h2 class="display-4 text-secondary"> Notícias </h2>
                </div>

                <div class="row text-center menu">
                    <div class="p-3 col-sm-6 col-lg-3">
                        <a href="news/registry.php" class="block btn btn-info py-5 col-12">
                            <img src="_img/news/registry.png" alt="Cadastrar">
                            <p class="mt-2"> Cadastrar </p>
                        </a>
                    </div>
                    
                    <div class="p-3 col-sm-6 col-lg-3">
                        <a href="news/history.php" class="block btn btn-info py-5 col-12">
                            <img src="_img/news/history.png" alt="Histórico">
