        ...
        <section class="my-5 text-center">
            <div class="container">
                ...
                <div class="row">
                	...
                	<?php
                		$query = getConn()->prepare("SELECT * FROM table_user WHERE id='{$_GET['id']}'");
						$query->execute();
						$result = $query->fetchObject();
					?>
                	
                	<form class="col-10 col-md-6 col-lg-4" action="../_routines/users/update.php" method="post" enctype="multipart/form-data">
                    	...
                    	<div class="form-group">
                  		...
                  		<div class="form-group">
                    		<select name="level" class="form-control" required>
                           		<option value="<?php echo $result->level; ?>" selected> Atual: <?php echo $result->level; ?> </option>
